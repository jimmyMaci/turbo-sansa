...
create table events (id int4 not null, consultant varchar(64), content varchar(21845), difficulty varchar(255), duration int4, eventtype varchar(255), head varchar(21845), introduction varchar(21845), locale varchar(64), material bool, name varchar(64), price numeric(19, 2), provider bytea, requirements varchar(21845), subscribermax int4, subscribermin int4, targetgroup varchar(21845), categories_id int4, primary key (id));
...
create table offered_event_locations (id int4 not null, location_description varchar(21845), location_equipment_description varchar(21845), offered_from_description varchar(21845), support_description varchar(21845), user_id int4, event_location_data_id int4, provider_id int4, user_address_id int4, primary key (id));
