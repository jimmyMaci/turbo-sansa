...
public class UserManagementFactory implements Serializable {
	 ...
	 */
	public Attributes newAttributes(Integer id, String type, String name, String value) {
	 ...
	 * @return the attributes
	 */
	public Attributes newAttributes(String type, String name, String value) {
		return newAttributes(null, type, name, value);
	}
