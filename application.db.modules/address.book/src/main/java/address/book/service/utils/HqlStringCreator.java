...
public class HqlStringCreator {
	...
	public static String forZipcodes(Countries country, String zipcode,
			String city) {
	...
	public static String forCountries(String iso3166A2name,
			String iso3166A3name, String iso3166Number, String name) {
		StringBuilder sb = new StringBuilder();
		sb.append("select c from Countries c");
		boolean iso3166A2nameIsNotNull = iso3166A2name != null
				&& !iso3166A2name.isEmpty();
		if (iso3166A2nameIsNotNull) {
			sb.append(" ");
			sb.append("where c.iso3166A2name=:iso3166A2name");
		}
		boolean iso3166A3nameIsNotNull = iso3166A3name != null
				&& !iso3166A3name.isEmpty();
		...
		boolean iso3166NumberIsNotNull = iso3166Number != null
				&& !iso3166Number.isEmpty();
...
//			Federalstates federalstate, 
			String geohash, String latitude,
			String longitude
...
//			Zipcodes zipcode
	...
	public static String getGeohashFirstRingQuery() {
		...
		sb.append( "select address.geohash from Addresses address "
				// First ring...
				+ "where address.geohash like :" + Adjacent.CENTER+ " "
				+ "or address.geohash like :" + Adjacent.TOP + " "
				+ "or address.geohash like :" + Adjacent.TOP_RIGHT + " "
				+ "or address.geohash like :" + Adjacent.RIGHT + " "
				+ "or address.geohash like :" + Adjacent.BOTTOM_RIGHT + " "
				+ "or address.geohash like :" + Adjacent.BOTTOM +" "
				+ "or address.geohash like :" + Adjacent.BOTTOM_LEFT + " "
				+ "or address.geohash like :" + Adjacent.LEFT +	" "
	...
	public static String getGeohashFirstAndSecondRingQuery() {
		...
		sb.append( "select address.geohash from Addresses address "
				...
				+ "or address.geohash like :" + Adjacent.TOP_TOP + " "
				+ "or address.geohash like :" + Adjacent.TOP_RIGHT_TOP + " "
				+ "or address.geohash like :" + Adjacent.TOP_RIGHT_TOP_RIGHT + " "
				+ "or address.geohash like :" + Adjacent.TOP_RIGHT_RIGHT +" "
				+ "or address.geohash like :" + Adjacent.RIGHT_RIGHT + " "
				...
				+ "or address.geohash like :" + Adjacent.LEFT_LEFT + " "
				+ "or address.geohash like :" + Adjacent.TOP_LEFT_LEFT + " "
